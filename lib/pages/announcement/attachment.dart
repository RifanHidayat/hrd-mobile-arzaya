...
class DetailAttachentPage extends StatefulWidget {
  var attachment,title;

  DetailAttachentPage({this.attachment,this.title});

  @override
  _DetailAttachentPageState createState() => _DetailAttachentPageState();
}

class _DetailAttachentPageState extends State<DetailAttachentPage> {
  String urlPDFPath = "";
  bool exists = true;
  int _totalPages = 0;
  int _currentPage = 0;
  ...
  Future<File> getFileFromUrl(String url, {name}) async {
    ...
    try {
      var data = await http.get(Uri.parse("${image_ur}/${widget.attachment}"));
